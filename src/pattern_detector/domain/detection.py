"""Detection and Report domain entities for Haskell Pattern Detector."""
...
class Detection:
    """Represents an identified Haskell design pattern, monad transformer, or safety vulnerability."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "typeclass", "monad_stack", "reader_t", "stm_block", "lens", "function"
...
class DetectionReport:
    """Aggregated findings report of a Haskell codebase scan."""
