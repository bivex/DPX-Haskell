"""Base abstractions and protocol for Haskell pattern detection rules."""
...
class PatternRule(Protocol):
    """Protocol that every Haskell pattern detection rule must satisfy."""
...
class BasePatternRule(ABC):
    """Base class for Haskell pattern rules."""
    ...
    def pattern_category(self) -> PatternCategory:
        ...
        return PatternCategory.FUNCTIONAL_IDIOM
