"""Inbound (driver) ports for the Haskell pattern detector application layer."""
...
@dataclass
class ScanOptions:
    """Configuration options for a Haskell codebase scan execution."""
...
class ScannerPort(Protocol):
    """Primary inbound port for scanning Haskell codebases and returning DetectionReports."""
...
class DetectorPort(Protocol):
    """Inbound port for executing pattern detection rules on a Haskell CodeModel."""
